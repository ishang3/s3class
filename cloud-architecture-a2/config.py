...
class Config:
    ...
    VOC_TRAIN_ROOT = './data/VOCdevkit'
    VOC_TEST_ROOT = './data/VOCdevkit'
    ...
    lr_scheduler_start_epoch = 120
    
    save_folder = 'weights/'
    backbone_network_name = 'resnet_50'
    exp_information_name = 'one_exp'
    basenet = 'torchvision_pretrained_resnet_rmfc/resnet50.pth'
